<template>
  ...
  <div class="p_both10 p-t-5">
    <!-- 展示图片 -->
    <div>
      <p class="font16 color-1f85aa border-b-e0 p-b-10 font-w6">展示图片</p>
      <div class="flex_dom flex_wrap p-v-20">
        ...
        >
          ...
          <div class="between-center m-v-5 wid80">
            <span class="text-center color-1f85aa font14 m-r-5">{{ item.Label }}</span>
            <el-upload
              :auto-upload="false"
              action
    ...
    <div class="m-t-20">
      <p class="font16 color-1f85aa border-b-e0 p-b-10 font-w6">任课老师</p>
      <div class="flex_dom flex_wrap p-v-20">
        <div
    ...
    <!-- 宣传视频 -->
    <div class="m-t-20">
      <p class="font16 color-1f85aa border-b-e0 p-b-10 font-w6">宣传视频</p>
      <div class="m-t-30">
        <el-form
          ref="refvideoForm"
          :model="videoRowData"
